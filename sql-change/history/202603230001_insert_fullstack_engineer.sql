-- 新增全栈工程师角色
-- 执行时间: 2026-03-23
-- 说明: 插入全栈工程师系统预置角色，能独立完成项目开发全流程

-- 先清理可能存在的旧数据
DELETE FROM agent_configs WHERE role = 'fullstack_engineer';

-- 全栈工程师
INSERT INTO agent_configs (id, name, role, description, system_prompt, max_tokens, temperature, is_default, is_system, created_at, updated_at)
