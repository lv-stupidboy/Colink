...
func TestOpenCodeGenerateConfigCopiesAssets(t *testing.T) {
	root := t.TempDir()
	skillID := uuid.New()
	...
	generator := NewOpenCodeConfigGenerator(skillStorage, subagentStorage, commandStorage, ruleStorage, zap.NewNop())
...
func TestOpenCodeGenerateConfigFallsBackToSubagentContentAndSkipsMissingAssets(t *testing.T) {
	root := t.TempDir()
	generator := NewOpenCodeConfigGenerator(
...
func TestOpenCodePreviewConfigEmpty(t *testing.T) {
	generator := NewOpenCodeConfigGenerator("", "", "", "", zap.NewNop())
...
func TestOpenCodeCopyHelpers(t *testing.T) {
	root := t.TempDir()
	generator := NewOpenCodeConfigGenerator("", "", "", "", zap.NewNop()).(*OpenCodeConfigGenerator)
