// internal/service/agent/plugins/claude_code/config_generator.go
package claude_code
...
// ClaudeConfigGenerator ClaudeCode 配置生成器
type ClaudeConfigGenerator struct {
...
// NewClaudeConfigGenerator 创建 ClaudeCode 配置生成器
func NewClaudeConfigGenerator(
	skillStoragePath string,
	subagentStoragePath string,
	commandStoragePath string,
	ruleStoragePath string,
...
// GenerateConfig 生成 ClaudeCode 配置
func (g *ClaudeConfigGenerator) GenerateConfig(ctx context.Context, req *agent.ConfigGenerateRequest) (*agent.ConfigGenerateResult, error) {
	configPath := req.ConfigPath

	g.logger.Info("开始生成ClaudeCode配置",
	...
	g.logger.Info("ClaudeCode配置生成完成",
...
func (g *ClaudeConfigGenerator) PreviewConfig(ctx context.Context, req *agent.ConfigPreviewRequest) (*agent.ConfigPreviewResult, error) {
	// 预览逻辑（可选实现）
...
func (g *ClaudeConfigGenerator) copySkill(skill *model.Skill, targetDir string) error {
...
func (g *ClaudeConfigGenerator) copyCommand(command *model.Command, targetDir string) error {
...
func (g *ClaudeConfigGenerator) copySubagent(subagent *model.Subagent, targetDir string) error {
	// 文件名: {name}.md
...
func (g *ClaudeConfigGenerator) copyRule(rule *model.Rule, targetDir string) error {
...
func (g *ClaudeConfigGenerator) copySettingsDirectory(settings *model.Settings, targetDir string) error {
...
func (g *ClaudeConfigGenerator) copyDir(sourceDir, targetDir string) error {
	// 如果目标目录已存在，先删除
...
func (g *ClaudeConfigGenerator) copyDirContents(srcDir, destDir string) error {
...
// copyFile 执行一次文件复制
func (g *ClaudeConfigGenerator) copyFile(sourcePath, targetPath string) error {
