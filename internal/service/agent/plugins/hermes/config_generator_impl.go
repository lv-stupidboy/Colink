// internal/service/agent/plugins/hermes/config_generator_impl.go
// Hermes AssetConfigGenerator implementation
package hermes
...
// HermesConfigGenerator Hermes 配置生成器
type HermesConfigGenerator struct {
...
// NewHermesConfigGenerator 创建 Hermes 配置生成器
func NewHermesConfigGenerator(
	skillStoragePath string,
	subagentStoragePath string,
	commandStoragePath string,
	ruleStoragePath string,
...
// GenerateConfig 生成 Hermes 配置
func (g *HermesConfigGenerator) GenerateConfig(ctx context.Context, req *agent.ConfigGenerateRequest) (*agent.ConfigGenerateResult, error) {
	configPath := req.ConfigPath

	g.logger.Info("开始生成Hermes配置",
...
func (g *HermesConfigGenerator) PreviewConfig(ctx context.Context, req *agent.ConfigPreviewRequest) (*agent.ConfigPreviewResult, error) {
	// 预览逻辑（可选实现）
...
func (g *HermesConfigGenerator) copySkill(skill *model.Skill, targetDir string) error {
...
func (g *HermesConfigGenerator) copyCommand(command *model.Command, targetDir string) error {
...
func (g *HermesConfigGenerator) copySubagent(subagent *model.Subagent, targetDir string) error {
	// 文件名: {name}.md
...
func (g *HermesConfigGenerator) copyRule(rule *model.Rule, targetDir string) error {
...
func (g *HermesConfigGenerator) copySettingsDirectory(settings *model.Settings, targetDir string) error {
...
func (g *HermesConfigGenerator) copyDir(sourceDir, targetDir string) error {
	// 如果目标目录已存在，先删除
...
func (g *HermesConfigGenerator) copyDirContents(srcDir, destDir string) error {
...
// copyFile 执行一次文件复制
func (g *HermesConfigGenerator) copyFile(sourcePath, targetPath string) error {
